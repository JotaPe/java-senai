...
public class InfoNote {
	...
	public static void main(String[] args) {
		...
		InfoNote info = new InfoNote();// para chamar métodos desta classe mais
										// adiante
		int opcao = 8;
		do {
			info.mostrarMenu();
	...
	public void efetuarLogin() {
		...
		if (cliente != null) {//Teste para validar se o cadastro do cliente ocorreu no método cadastrarCliente
			logado = cliente.validarLogin(login, senha);
			if (logado) {//if logado == true
	...
	public void cadastrarCliente() {// Cadastro de CLIENTE
		...
		// ocorrer uma associação zero para cliente e um para funcionario
	...
	public void inserirNotebook() {
		...
		String serialNote = Teclado
				.lerTexto("Informe o número de série do notebook"
						+ " para compra: ");
