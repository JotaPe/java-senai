...
public class Q7 {
	...
	public static void main(String[] args) {
		...
		// Convertendo de String para int, pois a Classe GregorianCalendar 
		// não trabalha com String
		int diaint = Integer.parseInt(dia);
		int mesint = (Integer.parseInt(mes)) - 1; //Por conta dos meses estarem num vetor a partir da posição 0
		...
		System.out.println
		("A diferença entre a data do seu aniversário em 2012 e a data de hoje é de " +
		diferenca + " dias.");
