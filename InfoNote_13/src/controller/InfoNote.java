...
public class InfoNote {
	...
	public void cadastrarNotebook() {
		...
		String dataCadastro = DateFormat.getDateInstance(DateFormat.SHORT).
				format(new Date());
		
		Notebook notebook = NotebookDAO.inserirNotebook
				(serialNote, modelo, descricao, estoque, precoUnitario, figura, 
						dataCadastro);
	...
	public void editarNotebook() {
		...
		System.out.println("===========================================");
		String serialNote = Teclado.lerTexto
				("Digite o SerialNote do Notebook a ser atualizado: ");
		String descricao = Teclado.lerTexto("Descrição: ");
		int estoque = Teclado.lerInt("Estoque: ");
		double precoUnitario = Teclado.lerDouble("Preço Unitário: ");
		String figura = Teclado.lerTexto("Figura: ");
	...
	public void excluirNotebook() {
		...
		System.out.println("========================================");
		String serialNote = Teclado.lerTexto
				("Digite o SerialNote do Notebook a ser excluído: ");
